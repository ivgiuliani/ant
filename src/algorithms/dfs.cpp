...
/*
 * Inizializza e chiama l'algoritmo DFS sulla working memory
 */
uint32_t
algo_dfs(RuleSet *ruleset, Fact *initial, Fact *final, Options *options) {
	...
	SearchNode *result = dfs(ruleset, initial, final, limit, &expanded_nodes);
 ...
 */
SearchNode *
dfs(RuleSet *ruleset, Fact *initial, Fact *final, unsigned int depth_limit, unsigned int *expanded_nodes) {

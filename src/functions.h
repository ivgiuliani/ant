...
__WM_LHS_FUNC __ATTR(__FASTCALL, __NOTHROW, __HOT) RESOLVE_LHS_PREDICATE(string);
__WM_RHS_FUNC __ATTR(__FASTCALL, __NOTHROW, __HOT) RESOLVE_RHS_PREDICATE(string);
